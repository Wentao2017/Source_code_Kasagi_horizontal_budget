...
uuumean=0.;uuvmean=0.;vvvmean=0.                                            !Budget
vwwmean=0.;pmean=0.;pumean=0.;pvmean=0.                                            !Budget 
...
!      if (nrank==1) ux1(12,64,:)=-1.
   ...
   if(itime.gt.100000)then
    call STATISTIC(ux1,uy1,uz1,phi1,ta1,umean,vmean,wmean,phimean,uumean,vvmean,wwmean,&
                   ...
                   dvdxdvdx,dvdydvdy,dvdzdvdz,dwdxdwdx,dwdydwdy,dwdzdwdz,uuumean,uuvmean,&
                   vvvmean,vwwmean,pmean,pumean,pvmean,nxmsize,nymsize,nzmsize,&
                   ...
                   udpdy,dpdy,vdpdx,vdpdy,uvvmean,vttmean,dvdxdphidx,dvdydphidy,dvdzdphidz,phidpdy,&
                   vphivmean,vphiwmean,phidvdx,phidvdy,phidvdz,vdphidx,vdphidy,vdphidz,uuuumean,&
                   vvvvmean)                  !Budget
