...
real(mytype), save, allocatable, dimension(:,:,:) :: umean,vmean,wmean,uumean,vvmean,wwmean,uvmean,uwmean,&
                                                     vwmean,tmean,utmean,vtmean,wtmean,dudy,uuumean,uuvmean,vvvmean,&
                                                     vwwmean,pmean,pumean,pvmean,dudx,dudz,dvdx,dvdy,dvdz,&
                                                     ...
                                                     dudxdvdx,dudydvdy,dudzdvdz,udpdy,dpdy,vdpdx,vdpdy,uvvmean,vttmean,&
                                                     dvdxdphidx,dvdydphidy,dvdzdphidz,phidpdy,& 
                                                     vphivmean,vphiwmean,phidvdx,phidvdy,phidvdz,vdphidx,&
                                                     vdphidy,vdphidz,uuuumean,vvvvmean 
...
!arrays for statistic collection!pay attention to the size!
    ...
    allocate (uuumean(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))   !Budget
    ...
    allocate (pumean(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))    !Budget
    ...
    allocate (phidpdx(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    allocate (dpdx(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    allocate (phidudx(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    allocate (phidudy(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    allocate (phidudz(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    ...
    allocate (vdpdy(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    ...
    allocate (uuuumean(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    allocate (vvvvmean(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
